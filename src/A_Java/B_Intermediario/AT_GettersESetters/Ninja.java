...
public abstract class Ninja {
    ...
    /*Construtor → define como o objeto é construído.
    Getter → lê valores; define como o mundo lê os dados do objeto.
    Setter → altera valores; define como o objeto muda ao longo da vida.*/
